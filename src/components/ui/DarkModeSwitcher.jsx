...
import { getDarkModeStatus, setDarkModeInLocalStorage, updateDarkModeClass } from "../../assets/js/darkModeFunctions.js";
...
function DarkModeSwitcher() {
    ...
    return (
        <button  id="darkModeToggle" onClick={toggleDarkMode} title="Alternar modo escuro">
